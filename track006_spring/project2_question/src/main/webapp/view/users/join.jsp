    			...
    			if(value !== ""){
					...
					.then( data => {
						if(data.emailCheck){
							...
							target.textContent="중복된 이메일 입니다";
							target.className="my-3  alert  alert-danger  target";
						}
					}).catch(error => {
						target.textContent="서버오류";
