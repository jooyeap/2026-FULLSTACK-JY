...
<script>
   ...
   <div class="container  my-5">
      <h3>글 수정</h3>
      <form  action ="${pageContext.request.contextPath}/board/edit.do?bno=${dto.bno}"  method="post"
      	...
      	<div class="my-3">
      		<label for="file" class="form-label">기존 이미지</label>
      		<img class="form-control"
      			 src="${pageContext.request.contextPath}/upload/${dto.bimg}">
      		<input type="hidden" name=bimg value="${dto.bimg}">
      	</div>
