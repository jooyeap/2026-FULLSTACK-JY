...
<!-- 	header		 -->
   <div class="container  my-5">
      ...
      <form  action ="${pageContext.request.contextPath}/board/write.do?${_csrf.parameterName}=${_csrf.token}"  
		...
		<div class="my-3">
      	...
      	<div  class="my-3  text-end"> 
      		...
      		<a href="list.do"     class="btn btn-outline-success"  title="목록보러가기">목록</a>
