...
// 1. 클래스는 부품객체이다
// 2. 상태(멤버변수:클래스변수(static), 인스턴스변수와) 행위(멤버함수)를 갖는다.
// 3. 상속 -> 클래스의 재사용,재활용
/*
	...
	4) 객체가 생성(닫히는 순서) : Object -> A -> B -> C 	5 6 7 8
*/
...
/*
	...
	6. 문법
		class 자식 클래스 extends 부모클래스 				(사용가능) -> 단일 상속
		class 자식 클래스 extends 부모클래스1, 부모클래스2 	(사용불가) -> 누구껄 상속 받았는지 확인을 할 수 없음
