...
public class Poly004 {
	public static void main(String[] args) {
		...
		// 2. {b=20, @toString} - {a-10, toString} = 2번지 {b=20,@toString} - {a=10, toString}
		
//		tb = (TestB4)ta; // ta 에서는 TestB4가 생성자에 의해 호출되서 초기화가 안됐으니 오류 발생
...
//		System.out.println(tb.a);
		...
		// 보장범위 {a=10,--} = 3번지 {b=20,@--}-{a=10,--}
		tb = (TestB4) ta; // (TestB4)로 인해서 위 3번지 안까지 사용가능한것임
		// {b=20, @toString}-{a=10,--} = 1번지 {a=10, toString)
		System.out.println(tb);
		System.out.println(tb.b);
		System.out.println(tb.a);
