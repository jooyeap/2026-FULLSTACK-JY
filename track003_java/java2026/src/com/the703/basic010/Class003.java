...
//	public Car32() { color="white"; } // 기본 생성자 - 2)생성자를 개발자가 수동으로 만들때 자동생성 취소 
	public Car32(String color) { super(); this.color = color; } // 필드있는 생성자
	@Override public String toString() { return "Car32 [color=" + color + "]"; } // 상태확인
}
public class Class003 {
	public static void main(String[] args) {
		Car31 car1 = new Car31(); // 1. new (객체 생성) 2. Car31()초기화 3. car1에 번지
		System.out.println(car1); // 번지
		
		Car32 car3 = new Car32("red");
		System.out.println(car3 + "\t" + car3.color);
		
//		Car32 car2 = new Car32(); // 1. new (객체 생성) 2. Car32()초기화=null 3. car2에 번지
...
///////////////////////////////////////////////////////////////////////////////
/*
 1. 생성자 - new 연산자에 의해서 호출하여 초기화를 담당
 2. 기본생성자
  - 모든 클래스에 생성자가 반드시 존재
  - 생성자선언을 생략할땐 컴파일러가 자동으로 기본생성자를 추가
  - 개발자가 선언시 컴파일러가 자동으로 생성 취소
    alt +shift + s
