...
5) jdbc 연동끊기
      ...
      //////////////////////////////////////////////////////////////////////////////////
      //3. jdbc연동 끊기
      if(pstmt != null){ out.println("pstmt close"); pstmt.close(); }
      if(conn != null){ out.println("연동 close"); conn.close(); }
	  ...
	  rset = pstmt.executeQuery(); // 표 - select / executeUpdate - insert, update, delete
