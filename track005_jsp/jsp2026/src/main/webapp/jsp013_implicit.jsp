...
2. jsp에서 다른페이지로 이동
	1) sendRedirect - 브라우저의 url을 변경o, request/response 객체가 유지가 안됨
	2) requestDispatcher - 위임(요청전달)
			 브라우저의 url을 변경x, request/response 객체가 유지 됨
      </pre>
      <%
      	// ver-1 알림창 처리 안됨
      ...
      <%
      	// ver-2  jsp013_3.jsp
      	// request.getRequestDispatcher("jsp012_milks.jsp") 이용해서 여기서 처리
      	// response.sendRedirect("jsp013_3.jsp");
      %>
      <pre>
jsp013_implicit.jsp (1) : 나이 입력받는 폼
			 →  jsp013_4.jsp  처리 (2)
