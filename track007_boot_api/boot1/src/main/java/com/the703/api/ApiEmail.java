...
public class ApiEmail {
	...
	@Value("${naver.user}") private String user; // eyoung071212@gmail.com
	...
	public void sendMail(String subject, String content, String to) {
	      ...
	      try {
	         ...
	         message.setContent("" 
	                ...
	                + "<p style='font-size:12px; color:#888; text-align:center;'>이 메일은 자동 발송된 안내 메일입니다.<br>문의: <a href='mailto:eyoung071212@naver.com' style='color:#005bac; text-decoration:none;'>cozizii@naver.com</a></p>"
	                + "</div>"
